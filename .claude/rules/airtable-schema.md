...
**Write permission exception:** Claude can read AND write to this base only. Every other Airtable base remains read-only. Always show B the proposed change before committing a write.
